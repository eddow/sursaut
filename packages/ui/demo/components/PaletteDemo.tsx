...
function BaseConfigurator({
	...
	const descriptor = (scope as Record<string, unknown>).descriptor as
		| Pick<
			ReturnType<DemoPalette['describeItemConfiguration']>,
			'presentation' | 'structure' | 'bindings' | 'title' | 'subtitle'
		>
		| undefined
	...
	return (
		<div class="palette-demo-panel">
			<div class="palette-default-config-toolbar">
				<div>
					<div class="palette-default-panel-title">Item configuration</div>
				</div>
				<button
...
const demoInspection = {
	...
	get scope() {
		return {
			...
			toolbar: this.entry?.toolbar,
			toolbarIndex: this.entry?.toolbarIndex,
...
export default function PaletteDemo() {
	...
	return (
		<Ide
			...
			el:class={[
			'palette-demo-root',
			`palette-demo-theme-${demoState.theme}`,
			demoState.theme === 'light' ? 'palette-default-theme-light' : undefined,
		]}
		...
		>
			<div class={['palette-default-center-content', centerOverlay.visible ? 'is-dimmed' : undefined]}>
				...
				<div class="palette-demo-panel">
					<div class="palette-default-panel-title">Live state</div>
