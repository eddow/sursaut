...
export const navigation: NavSection[] = [
	...
	},
	{
		...
		links: [
			...
			{ title: 'Display & Theme', href: '/kit/display' },
			{ title: 'Head', href: '/kit/head' },
		],
	},
	{
		title: '@sursaut/ui',
		...
		links: [
			...
			{ title: 'IconPicker', href: '/ui/icon-picker' },
			{ title: 'Group + Nav', href: '/ui/group-nav' },
			{ title: 'Split + Theme', href: '/ui/split-theme' },
			...
			{ title: 'Dockview family', href: '/ui/dockview' },
			{ title: 'CSS Variables', href: '/ui/css-variables' },
			{ title: 'Display & Theme (→ /kit/display)', href: '/ui/display' },
	...
	},
	{
		...
		links: [
			...
			{ title: 'Decorators', href: '/mutts/decorators' },
		],
	},
	{
		title: 'pure-glyf',
		...
		links: [
			...
			{ title: 'Setup', href: '/pure-glyf/setup' },
